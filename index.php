...
$properties = array(
		'64061651400' => array('name' => "Station Casinos", 'url' => 'https://www.facebook.com/stationcasinos?sk=app_257451507634202', 'img' => 'room2.jpg'),
		'165106597073' => array('name' => "Texas Station", 'url' => 'https://www.facebook.com/texasstation?sk=app_257451507634202', 'img' => 'room_texasstation.jpg'),
		'53201180527' => array('name' => "Sunset Station", 'url' => 'https://www.facebook.com/sunsetstation?sk=app_257451507634202', 'img' => 'room_sunsetstation.jpg'),
		'157108104327456' => array('name' => "Santa Fe Station", 'url' => 'https://www.facebook.com/SantaFeStation?sk=app_257451507634202', 'img' => 'room_santafe.jpg'),
		'52412782331' => array('name' => "Palace Station", 'url' => 'https://www.facebook.com/palacestation?sk=app_257451507634202', 'img' => 'room_palace.jpg'),
		'165791767689' => array('name' => "Boulder Station", 'url' => 'https://www.facebook.com/boulderstation?sk=app_257451507634202', 'img' => 'room_boulder.jpg'),
		'47094012308' => array('name' => "Aliante Station", 'url' => 'https://www.facebook.com/aliantestation?sk=app_257451507634202', 'img' => 'room_aliante.jpg'),
		'44758789266' => array('name' => "Green Valley Ranch", 'url' => 'https://www.facebook.com/greenvalleyranch?sk=app_257451507634202', 'img' => 'room_greenvalley.jpg'),
		'119039581451551' => array('name' => "Fiesta Casinos", 'url' => 'https://www.facebook.com/fiestacasinos?sk=app_257451507634202', 'img' => 'room_henderson.jpg'),
		'54202046498' => array('name' => "Red Rock", 'url' => 'https://www.facebook.com/RedRock?sk=app_257451507634202', 'img' => 'room_redrock.jpg')
	);
	...
	$.ajax({
		...
		success: function(data) {
			if(data.result == "success") {
				window.location = "thankyou.php?pageid=<?=$signed_request['page']['id']?>";
...
function showError(msg) {
	$('#error').html('<p style="color:red;">' + msg + '</p>');
}
...
function checkForm() {
	...
	if(!$("input[name='age']").is(":checked")) {
		showError("Please verify you are 21 or over.");
		return false;
	}
...
<div class="content">
		<img src="images/<?=$properties[$signed_request['page']['id']]['img']?>" style="float:right;margin-left:18px;border:1px solid black;" />
        ...
        <div id="social">
        	<div id="twitter">
            	<iframe allowtransparency="true" frameborder="0" scrolling="no" src="https://platform.twitter.com/widgets/tweet_button.html?url=<?=rawurlencode($properties[$signed_request['page']['id']]['url'])?>&text=<?=rawurlencode($tweetData)?>&count=none" style="width:65px; height:22px;"></iframe>
	...
	<div class="content" style="padding-bottom:20px;border-bottom:1px solid black;">
    	...
    	<form id="subscribeForm" action=""  name="subscribeForm" method="post" onsubmit="return false">
            ...
            <br class="clear" />
            <p style="text-align:center;margin-bottom:10px;">ALL FIELDS ARE REQUIRED.</p>
            <p style="text-align:center;margin-bottom:10px;"><span style="font-size:9px; float:left; text-align:left; margin-left:15px">By checking the box you confirm you are 21+ years of age<br /> and have read and agree to all the terms and conditions<br /> 
            of Station Casinos Privacy Policy.</span> 
              <input type="checkbox" name="age" id="age" value="Yes I am 21" />
            &nbsp; &nbsp;<input type="image" src="images/button_enter.jpg" height="23" width="88" alt="Submit" style="margin-bottom:-4px;" /></p>
            <p style="text-align:center;margin-bottom:10px;"><a href="https://www.facebook.com/note.php?note_id=10150462268809175" target="_blank">Contest Rules</a></p>
        </form>
    </div>
    
    <div class="content" style="text-align:center;">
    	<a href="https://www.facebook.com/note.php?note_id=10150326667054175" target="_blank"><img src="images/logo.jpg" height="48" width="169" alt="Station Casinos" /></a><br />
<br />
        ...
        <br /><br /><br />
        <span style="font-size:9px;">&copy; 2011 Station Casinos. All Rights Reserved. <a href="https://www.facebook.com/note.php?note_id=257451507634202" target="_blank">CONTEST RULES</a></span>
    </div>
   <?
    if(!$like_status && $_GET['logged'] == "") {
		//fangate stuff here
		echo '<img src="images/Like-Gate-thanks.jpg" height="850" width="520" alt="" style="position:absolute;top:0px;left:0px;border:0" />';
